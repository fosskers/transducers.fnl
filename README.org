...
Looking for Transducers in other Lisps? Check out the [[https://github.com/fosskers/cl-transducers][Common Lisp]] and [[https://github.com/fosskers/transducers.el][Emacs Lisp]]
implementations!
...
To generate documentation and run unit tests:

#+begin_example
fenneldoc transducers.fnl
#+end_example

To manually run some testing scripts:

#+begin_example
cd tests/
fennel --lua lua table.fnl
fennel --lua luajit table.fnl
#+end_example
